...
<html>
	 <head>
        <meta charset="utf-8"/>
        <title>CoproManager - Inscription</title>
	 ...
	 <body>
		...
		<section class="container">
			...
			<ul class="nav nav-tabs">
				<li class="active">
					<a href="#particulier" data-toggle="tab">Particulier</a>
				</li>
				<li>
					<a href="#syndic" data-toggle="tab">Syndic</a>
				</li>
			</ul>
			<div class="tab-content">
				...
				<div class="tab-pane active" id="particulier">
					...
					<s:form id="inscriptionForm" action="inscriptionFormP">   

						<s:select label="Type" name="cp.type" size="1" list="#{'proprietaire':'Proprietaire', 'locataire':'Locataire'}" multiple="false" required="required"/>

						<s:textfield label="Nom" name="cp.nom" required="required"/>

						<s:textfield label="Prénom" name="cp.prenom" required="required"/>

						<s:textfield label="Email" name="cp.mail" required="required"/>

						<s:password label="Mot de passe" name="cp.mdp" required="required"/>
						
						<s:password label="Mdp confirmation" name="cp.mdpc" required="required"/>
						
						<s:a href="#"><s:checkbox name="cp.condition" key="Conditions Générales" required="required"/></s:a>

						<div class="sansLabel">
							<%--<s:submit key="Annuler" action="Effacer"/>--%>
				...
				<!--Syndic-->
				<div class="tab-pane" id="syndic">
				
					<s:form id="inscriptionForm" action="inscriptionFormS">   

						<s:textfield label="Nom" name="s.nom" required="required"/>

						<s:textfield label="Prénom" name="s.prenom" required="required"/>

						<s:textfield label="Email" name="s.mail" required="required"/>

						<s:password label="Mot de passe" name="s.mdp" required="required"/>
						
						<s:password label="Mdp confirmation" name="s.mdpc" required="required"/>
						
						<s:a href="#"><s:checkbox name="s.condition" key="Conditions Générales" required="required"/></s:a>

						<div class="sansLabel">
							<%--<s:submit key="Annuler" action="Effacer"/>--%>
							<s:submit key="Valider" name="submitSyndic" class="btn btn-large btn-primary"/> 
						</div>
