...
<html>
	 <head>
        <meta charset="utf-8"/>
        <title>CoproManager - Modif de facture</title>
		...
		<section class="main-body">
			<div class="container">
				<div class="row-fluid">
	         		<div class="span12">
						<div class="span12">
					   		<h3 class="header">Facture
					            <span class="header-line"></span> 
					        </h3>
					    </div>
				  		
				  		<h4>Sujet</h4>
				  		<p><c:out value="${sessionScope.f.getSujet()}"/></p>
				  		<br>
				  		
				  		<h4>montant</h4>
				  		<p><c:out value="${sessionScope.f.getMontantAPayer()}"/></p>
				  		<br>
				  		
				  		<h4>detail</h4>
				  		<p><c:out value="${sessionScope.f.getDetail()}"/></p>
				  		<br>
