...
<html>
	 <head>
        <meta charset="utf-8"/>
        <title>CoproManager - Modification de Budget</title>
		...
		<section class="main-body">
			<div class="container">
				<div class="row-fluid">
	         		<div class="span12">
						<div class="span12">
					   		<h3 class="header">Budget Prévisionnel
					            <span class="header-line"></span> 
					        </h3>
					    </div>
				  		
				  		<h4>Année</h4>
				  		<p><c:out value="${sessionScope.b.getAnnee()}"/></p>
				  		<br>
				  		
				  		<h4>Budget eau</h4>
				  		<p><c:out value="${sessionScope.b.getBudgetEau()}"/></p>
				  		<br>
				  		
				  		<h4>Budget électricité</h4>
				  		<p><c:out value="${sessionScope.b.getBudgetElectricite()}"/></p>
				  		<br>
				  		
				  		<h4>Budget gaz</h4>
				  		<p><c:out value="${sessionScope.b.getBudgetGaz()}"/></p>
				  		<br>
				  		
				  		<h4>Budget entretien</h4>
				  		<p><c:out value="${sessionScope.b.getBudgetEntretien()}"/></p>
				  		<br>
				  		
				  		<h4>Budget commentaire</h4>
				  		<p><c:out value="${sessionScope.b.getCommentaire()}"/></p>
				  		<br>
