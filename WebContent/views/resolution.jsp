...
<html>
    <head>
        <meta charset="utf-8"/>
        <title>CoproManager - Demandes de résolution</title>
    ...
    <body>
		...
		<section class="container">			
			...
			<div class="row-fluid">
	           	<div class="span12">
			   		<h3 class="header">Demandes de Résolution
		       	...
		       	<div class="span12" id="travaux">
	           		<table class="table table-striped table-bordered table-hover">
	                    ...
	                    <tbody>
	                    	<c:forEach var="t" items="${listResolution}">
	                    		<c:choose>
	                    			...
	                    			<c:otherwise>
	                    				<tr>
				                          	...
				                          	<td class="avis">
					                          	<div class="pos">
						                          	<a href="<c:url value='plusRes'><c:param name="sjt" value="${t.getSujet()}" /></c:url>">
					                          	...
					                          	<div class="neg">
					                          		<a href="<c:url value='moinsRes'><c:param name="sjt" value="${t.getSujet()}" /></c:url>">
					                          	...
					                          	<div class="modif">
						                          	<a href="<c:url value='modifRes'><c:param name="dt" value="${t}" /></c:url>" >
		...
		<div class="modal hide fade" id="modalAjoutTrav">
		  	...
		  	<div class="modal-header">
		    	...
		    	<h3>Ajouter une demande de résolution</h3>
		  	</div>
		
		  	<s:form action="resolutionFormAj">
		
			  	<div class="modal-body">
			    	<s:textfield label="Sujet" name="dr.sujet" required="required"/>
					
					<s:textarea label="contenu" name="dr.contenu" required="required" cols="20" rows="10"/>
