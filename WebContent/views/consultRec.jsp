		...
		<section class="main-body">
			<div class="container">
				<div class="row-fluid">
	         		<div class="span12">
						<div class="span12">
					   		<h3 class="header">Demandes de Réclamation
					            <span class="header-line"></span> 
					        </h3>
					    </div>
				  		
				  		<h4>Etat</h4>
				  		<p><c:out value="${sessionScope.dt.getEtat()}"/></p>
				  		<br>
				  		
				  		<h4>Sujet</h4>
				  		<p><c:out value="${sessionScope.dt.getSujet()}"/></p>
				  		<br>
				  		
				  		<h4>Contenu</h4>
				  		<p><c:out value="${sessionScope.dt.getContenu()}"/></p>
				  		<br>
				  		
				  		<h4>Créée le</h4>
				  		<p><c:out value="${sessionScope.dt.getDate()}"/></p>
				  		<br>
	         		...
	         		<c:if test="${sessionScope.type == 'admin' || sessionScope.type == 'syndic'}">
		         		...
		         		<a href="<c:url value='refuserRec'><c:param name="sjt" value="${sessionScope.dt.getSujet()}" /></c:url>" >
