			...
			<div class="container">
				<div class="row-fluid">
	         		<div class="span12">
							...
							<s:form action="reclamationFormModif">
							  	...
							  	<div class="modal-body">
									...
									<c:if test="${sessionScope.type == 'syndic' || sessionScope.type == 'admin'}">
										<s:select label="Etat" name="dt.etat" size="1" list="#{'NON LU':'NON LU', 'LU':'LU'}" multiple="false" required="required"/>
									</c:if>
